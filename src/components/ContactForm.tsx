    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setIsOpen(false)}>
      <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto p-6" onClick={e => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-2xl font-bold">Contact AlbaniaVisit</h2>
            <p className="text-xs text-gray-500 mt-1">Direct message to our team</p>
          </div>
          <button
        ...
        <p className="text-sm text-gray-600 mb-4">
          You're contacting <strong>AlbaniaVisit.com</strong> directly. We'll help with general inquiries, trip planning, and destination questions.
        </p>
