...
- main:
  ...
  - region "Tour filters":
    - button "Hide tour filters" [expanded]: Filter Tours
    - group "Filter options":
      - group "Filter by country":
        - text: Filter by country
        - combobox "Filter by country":
          - option "All Countries" [selected]
          - option "Albania"
          - option "Kosovo"
          - option "Montenegro"
          - option "North Macedonia"
        - text: Filter tours by country
      - group "Filter by difficulty level":
        - text: Filter by difficulty level
        - combobox "Filter by difficulty level":
          - option "All Difficulties" [selected]
          - option "Easy"
          - option "Moderate"
          - option "Challenging"
          - option "Difficult"
        - text: Filter tours by difficulty level
      - group "Filter by duration in days":
        - text: Filter by duration in days
        - spinbutton "Minimum duration in days"
        - spinbutton "Maximum duration in days"
      - group "Filter by price range in euros":
        - text: Filter by price range in euros
        - spinbutton "Minimum price in euros"
        - spinbutton "Maximum price in euros"
      - group "Filter by group size":
        - text: Filter by group size
        - combobox "Filter by group size":
          - option "Any Group Size" [selected]
          - option "Small Group"
          - option "Large Group"
        - text: Filter tours by group size
      - group "Sort tours by":
        - text: Sort tours by
        - combobox "Sort tours":
          ...
          - 'option "Duration: Short to Long"'
        - text: Sort tour results
  - article:
